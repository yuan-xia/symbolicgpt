...
def main():
    ...
    numVars = [1]#list(range(1,10)) #list(range(31)) #[1,2,3,4,5]
    decimals = 1
    ...
    testRange = [-10.0,10.0] #[[-5.0, 3.0],[-3.0, 5.0]] # this means Union((-5,-1),(1,5))
    ...
    threshold = 5000
    templateProb = 0.0#0.1#1.0 #0.3 # the probability of generating an equation from the templates
    templatesEQs = {
        1: [
            # NGUYEN
